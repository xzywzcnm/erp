...
export const pdsSettingApi = {
  // 尺码类型管理
  sizeTypeManage: {
    queryProductSizeTemplate: '/pds-service/pds/lapa/workbench/product/queryProductSizeTemplate',
    saveProductSizeTemplate: '/pds-service/pds/lapa/workbench/product/saveProductSizeTemplate',
    queryProductSizeTemplateName: '/pds/lapa/workbench/product/queryProductSizeTemplateName'
  },
  // 尺码部位管理
  sizePartsManage: {
    // 尺码部位-查询
