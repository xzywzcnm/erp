<template>
  <div v-if="systemNoticeList.length >0">
    <Modal v-model="systemNoticeModal" class-name="systemNoticeStyle" title="系统公告" width="800" :transfer="false" :mask-closable="false" @on-visible-change="systemNoticeModalChange">
