<template >
  <div class="upcGenerationRules_box">
    ...
    <Button type="primary" @click="AddCodeTtem" v-if="getPermission('productUpcSetting_insert')"
      style="margin: 10px 0;">添加编码项</Button>
    <Table highlight-row border :loading="tableLoading" draggable @on-drag-drop="dragDrop" :columns="columns"
      :data="codeData"></Table>
    <!--添加编码项弹窗-->
    <Modal v-model="codeTtemTalg" :mask-closable="false" :title="code_txt" class-name="modal_codeStyle" :transfer="false"
      @on-visible-change="visibleChange" width="700">
      <div class="line_box">
        <span class="redDot" style="margin-right: 8px;">属性项</span> <dyt-input v-model.trim="upcCodeName"
          style="width: 200px;" :disabled="!is_edit"></dyt-input>
      </div>
      ...
      <div class="attribute_line" v-for="(item, index) in attribute_data" :key="index">
        <span class="redDot" style="margin-right: 8px;">属性</span> <dyt-input v-model.trim="item.upcCodeName"
          :disabled="!is_edit" style="width: 200px;"></dyt-input>
        <span style="margin: 0 10px;">—</span> <span class="redDot" style="margin-right: 8px;">编码</span> <dyt-input
          v-model.trim="item.upcCode" :disabled="!is_edit" style="width: 200px;"></dyt-input>
    ...
    <!--流水号弹窗-->
    <Modal v-model="serialNumberTalg" width="360" :mask-closable="false" @on-visible-change="visibleChange"
      :title="code_txt">
      <div style="display: flex; align-items: center; margin-bottom: 10px;">
        <span style="margin-right: 8px;">流水号字符数</span>
        <dyt-inputNumber v-model="initIdCount" :min="0" :max="10" :disabled="!is_edit"
          style="width: 150px;"></dyt-inputNumber>
      </div>
      <div slot="footer" style="text-align: center;">
