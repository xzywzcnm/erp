...
<template>
  <div class="preview-main">
    <draggable v-model="dragList" chosenClass="chosen" forceFallback="true" group="people" animation="1000" @start="onStart" @end="onEnd" :disabled="!sort">
      <transition-group>
        <!-- 列表缩略图 -->
        <div v-for="(item, index) in fileList" :key="index" style="display:inline-flex;">
