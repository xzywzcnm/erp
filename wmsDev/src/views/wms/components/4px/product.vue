...
export default {
  ...
  data() {
    let v = this;
    return {
      importApi: api.wmsOutstoreProductInfoSkuRelatedImport, // 导入接口地址
      exportApi: api.wmsOutstoreProductInfoExport, // 导出接口地址
      getListApi: api.wmsOutstoreProductInfoQuery, // 列表接口地址
      productSyncApi: api.wmsOutstoreProductInfoSync, // 同步接口地址
      relatedObj: {
        firstShippingFee: 0,
