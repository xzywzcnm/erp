<template >
  <div>
        ...
        <Tabs value="main">
          <TabPane label="主信息" name="main" style="padding-left:12px;">
            <Row v-show="isShowNoAndStatus">
              ...
              <Form-item label="调拨单号：">
                <span>{{ curObj.inventoryAllotNo }}</span>
              </Form-item>
              </Col>
              <Col span="5">
              <!-- <Form-item label="状态：">
            ...
            <Row>
              ...
              <Form-item label="发货仓库：">
                <span>{{ curObj.fromWarehouseName }}</span>
              </Form-item>
              </Col>
              <Col span="2">
              <Icon type="md-arrow-dropright-circle" size="32" color="#2d8cf0"></Icon>
              </Col>
              <Col span="5">
              <Form-item label="目的仓库：">
                <span>{{ curObj.toWarehouseName }}</span>
              </Form-item>
              </Col>
            </Row>
            <Row>
              ...
              <Form-item label="运费/报关费/其他费用：">
                <Row :gutter="8">
                  <Col span="6">
                  <Select v-model="pageParams.currency" style="width: 120px" filterable :disabled="
                          $store.state.adjustDetailTableShow === 'isChecked'
                        ">
                    <Option v-for="item in currencyTypeList" :value="item.money" :key="item.money">{{ item.currencyName }}</Option>
                  </Select>
                  </Col>
                  <Col span="3">
                  <Form-item prop="feeFreight">
                    <Input v-model.trim="pageParams.feeFreight" @on-blur="freightFloatPoint" style="width: 70px" :disabled="
                            $store.state.adjustDetailTableShow === 'isChecked'
                          "></Input>
                  </Form-item>
                  </Col>
                  ...
                  <Form-item prop="feeDeclaration">
                    <Input v-model.trim="pageParams.feeDeclaration" @on-blur="declareFloatPoint" style="width: 70px" :disabled="
                            $store.state.adjustDetailTableShow === 'isChecked'
                          "></Input>
                  </Form-item>
                  </Col>
                  ...
                  <Form-item prop="feeOther">
                    <Input v-model.trim="pageParams.feeOther" @on-blur="amountFloatPoint" style="width: 70px" :disabled="
                            $store.state.adjustDetailTableShow === 'isChecked'
                          "></Input>
                  </Form-item>
                  </Col>
            ...
            <Row>
              <Col span="6">
              <Form-item label="备注：">
                <Input type="textarea" :autosize="{ minRows: 5, maxRows: 6 }" placeholder="填写备注" v-model.trim="pageParams.remarks" :disabled="
                      $store.state.adjustDetailTableShow === 'isChecked'
                    "></Input>
              </Form-item>
              </Col>
            ...
            <Row>
              <Col span="6">
                <Form-item label="收货人名称：">
                  <Input v-model.trim="pageParams.consigneeName" placeholder="" style='width: 220px' :disabled="$store.state.adjustDetailTableShow==='isChecked'"></Input>
                </Form-item>
              </Col>
              <Col span="6">
                <Form-item label="国家：">
                  <Input v-model.trim="pageParams.consigneeCountry" placeholder="" style='width: 220px' :disabled="$store.state.adjustDetailTableShow==='isChecked'"></Input>
                </Form-item>
              </Col>
            </Row>
            <Row>
              <Col span="6">
                <Form-item label="联系人：">
                  <Input v-model.trim="pageParams.consigneeLinkMan" placeholder="" style='width: 220px' :disabled="$store.state.adjustDetailTableShow==='isChecked'"></Input>
                </Form-item>
              </Col>
              <Col span="6">
                <Form-item label="省/洲：">
                  <Input v-model.trim="pageParams.consigneeProvince" placeholder="" style='width: 220px' :disabled="$store.state.adjustDetailTableShow==='isChecked'"></Input>
                </Form-item>
              </Col>
            </Row>
            <Row>
              <Col span="6">
                <Form-item label="手机号码：" prop="consigneeLinkTel">
                  <Input v-model.trim="pageParams.consigneeLinkTel" placeholder="" style='width: 220px' :disabled="$store.state.adjustDetailTableShow==='isChecked'"></Input>
                </Form-item>
              </Col>
              <Col span="6">
                <Form-item label="城市：">
                  <Input v-model.trim="pageParams.consigneeCity" placeholder="" style='width: 220px' :disabled="$store.state.adjustDetailTableShow==='isChecked'"></Input>
                </Form-item>
              </Col>
              <Col span="6">
                <Form-item label="邮政编码：" prop="consigneeZipCode">
                  <Input v-model.trim="pageParams.consigneeZipCode" placeholder="" style='width: 220px' :disabled="$store.state.adjustDetailTableShow==='isChecked'"></Input>
                </Form-item>
              </Col>
            </Row>
            <Row>
              <Col span="6">
                <Form-item label="邮箱：" prop="consigneeMail">
                  <Input v-model.trim="pageParams.consigneeMail" placeholder="" style='width: 220px' :disabled="$store.state.adjustDetailTableShow==='isChecked'"></Input>
                </Form-item>
              </Col>
              <Col span="6">
                <Form-item label="详细地址1：">
                  <Input v-model.trim="pageParams.consigneeAddress" placeholder="" style='width: 220px' :disabled="$store.state.adjustDetailTableShow==='isChecked'"></Input>
                </Form-item>
              </Col>
              <Col span="6">
                <Form-item label="详细地址2：" prop="consigneeAddressOther">
                  <Input v-model.trim="pageParams.consigneeAddressOther" placeholder="" style='width: 220px' :disabled="$store.state.adjustDetailTableShow==='isChecked'"></Input>
                </Form-item>
              </Col>
            </Row>
          </TabPane>
          <TabPane label="物流商信息" name="logistic">
            <Row>
              <Col span="6">
                <Form-item label="物流商：">
                  <Select v-model="pageParams.logisticsDealerCode" style="width: 220px" filterable :disabled="$store.state.adjustDetailTableShow==='isChecked'" @on-change="changeLogisit" label-in-value>
              ...
              <Col span="6">
                <Form-item label="物流商单号：">
                  <Input v-model.trim="pageParams.logisticsNo" placeholder="" style='width: 220px' :disabled="$store.state.adjustDetailTableShow==='isChecked'"></Input>
                </Form-item>
              </Col>
            </Row>
            <Row>
              <Col span="6">
                <Form-item label="邮寄方式：">
                  <Select v-model="pageParams.logisticsMailCode" style="width: 220px" filterable :disabled="$store.state.adjustDetailTableShow==='isChecked'" @on-change="changeMailWay" label-in-value>
              ...
              <Col span="6">
                <Form-item label="运单号：">
                  <Input v-model.trim="pageParams.logisticsTrackingNo" placeholder="" style='width: 220px' :disabled="$store.state.adjustDetailTableShow==='isChecked'"></Input>
                </Form-item>
              </Col>
            </Row>
            <Row>
              <Col span="6">
                <Form-item label="联系人：">
                  <Input v-model.trim="pageParams.logisticsLinkMan" placeholder="" style='width: 220px' :disabled="$store.state.adjustDetailTableShow==='isChecked'"></Input>
                </Form-item>
              </Col>
              <Col span="6">
                <Form-item label="手机号码：" prop="logisticsLinkTel">
                  <Input v-model.trim="pageParams.logisticsLinkTel" placeholder="" style='width: 220px' :disabled="$store.state.adjustDetailTableShow==='isChecked'"></Input>
                </Form-item>
              </Col>
            </Row>
            <Row>
              <Col span="6">
                <Form-item label="邮箱：" prop="logisticsLinkMail">
                  <Input v-model.trim="pageParams.logisticsLinkMail" placeholder="" style='width: 220px' :disabled="$store.state.adjustDetailTableShow==='isChecked'"></Input>
                </Form-item>
              </Col>
            </Row>
          </TabPane> -->
    ...
    <!-- :添加货品和删除货品按钮 -->
    <div class="addBinding" v-if="isShowBtn">
    ...
    <div class="shopTable" v-if="$store.state.adjustDetailTableShow === 'noCheck'">
      <!--表格-->
      <Table highlight-row border :columns="columns6" :data="data6" ref="selection" :loading="TableLoading" @on-selection-change="selectItem" @on-select-all="allSelectItemBtn"></Table>
      <!--分页按钮-->
    ...
    <div class="addBinding" style="margin-top:80px; text-align:center;">
      <!-- <Button type="primary" style="margin-right:50px;" v-if="isCheckShow" @click="checkPassBtn('pageParams')">审核通过</Button> -->
      <!-- 生成出库单 -->
      ...
      <Tooltip placement="top" content="若表格无数据，则保存后会删除该调拨单！">
        <Button type="primary" style="margin-right:50px;" @click="saveTransferOrderBtn('pageParams')" icon="md-checkmark" v-if="isShow" :disabled="!getPermission('wmsInventoryAllot_modify')">保存</Button>
      </Tooltip>
    ...
    <div class="shopTable" v-if="cognateData.length">
      <!--关联出库单表格-->
      <dTable highlight-row border :loading="TableLoading" :columns="cognateColumns" :data="cognateData"></dTable>
      <!--分页按钮-->
      <div class="table-page">
        <div class="table-page-right">
          <Page :total="cognateTotal" :current="cognatePageParams.pageNum" @on-change="changePage" show-total :page-size="cognatePageParams.pageSize" show-elevator show-sizer @on-page-size-change="changePageSize" placement="top" :page-size-opts="pageArray"></Page>
        </div>
      </div>
    </div>
    <!-- :新建货品模态框 -->
    <div v-if="addProductModal">
      <Modal v-model="addProductModal" :styles="{ top: '80px', width: '1500px' }" class="headerBar" :title="transferProductModalTitle">
        <div class="content">
          <addProduct :eliminateData="data6" @addProductSuccess="userSelectOk" @addProductCancel="addProductModal = false" :wareId="curObj.fromWarehouseId"></addProduct>
        </div>
        <!--<div slot="footer">
    ...
    <Modal v-model="creatOutStockModal" v-if="creatOutStockModalStatus" width="1000" title="生成出库单">
      <div>
        ...
        <div style="marginTop:10px;">
          <Table highlight-row border :height="tableHeight" :loading="TableLoading" :columns="productColumn" :data="productData"></Table>
        </div>
        <!-- 收货人信息 -->
        ...
        <div style="marginTop:10px;marginLeft:15px;">
          <Form :model="outStockParams" label-position="left" :label-width="85">
            <Row style="marginLeft:15px;">
              <Col span="12">
              <Form-item label="物流商：">
                <Select v-model="outStockParams.logisticsDealerCode" style="width: 200px" filterable clearable @on-change="changeLogisit" label-in-value>
                  <Option v-for="item in logisticList" :value="item.code" :key="item.code">{{ item.name }}</Option>
                </Select>
              </Form-item>
              </Col>
              <Col span="8">
              <Form-item label="邮寄方式：">
                <Select v-model="outStockParams.logisticsMailCode" style="width: 200px" filterable clearable @on-change="changeMailWay" label-in-value>
                  <Option v-for="item in logisticsMailList" :value="item.code" :key="item.code">{{ item.name }}</Option>
                </Select>
              </Form-item>
              </Col>
      ...
      <div>
        ...
        <div v-if="step === 0">
          ...
          <h3 style="marginTop:20px;">
            货品信息 </h3>
          <div style="marginTop:10px;">
            <Table highlight-row border :loading="TableLoading" :height="tableHeight" :columns="declareColumn" :data="declareData"></Table>

          </div>
        </div>
        <div style="margin: 10px 0">
          <shipment v-if="step === 1" :timeStamp="timeStamp" @updateData="updateData" @deleteData="deleteData" :shipmentData="shipmentData"></shipment>
        </div>
      </div>
      <!-- 发货地址 -->
      <h3 style="marginTop:20px;">
      ...
      <Form :model="declarePageParams" label-position="left" :label-width="95">
        ...
        <div style="marginLeft:15px;">
          <Form-item label="Address：">
            <Input type="textarea" :autosize="{ minRows: 4, maxRows: 6 }" v-model.trim="declarePageParams.addressLine1" style="width: 400px"></Input>
          </Form-item>
        </div>
      </Form>
      <div slot="footer" style="text-align:center;">
        <Button type="primary" :loading="loading2" style="marginRight:10px;" v-if="step === 0" @click="nextStep">下一步</Button>
        <Button type="primary" style="marginRight:10px;" v-if="step === 1" :loading="loading3" @click="declareSave" :disabled="declareSaveStatus">提交货件至Amazon</Button>
...
import shipment from '@/views/wms/components/wms-inStock/shipment';
...
export default {
  ...
  data () {
    ...
    return {
      ...
      isShowNoAndStatus: true, // 单号和状态隐藏
      isShowBtn: true, // 添加货品和删除货品按钮默认显示
      isShow: true, // 保存按钮显示
      isCheckShow: true, // 审核按钮显示
      pageParams: {
        fromWareHouse: '', // 发货仓库
        toWareHouse: '', // 目的仓库
        currency: '', // 货币类型
              ...
              h('InputNumber', {
                ...
                on: {
                  'on-change': value => {
                    ...
                    if (self.data6[params.index].inventoryAllotDetailId) {
  ...
  watch: {
    '$store.state.adjustDetailWatchFlag': function (val) {
      var v = this;
      if (val) {
        if (this.curObj.allotStatus !== 0) {
          v.isShow = false; // 保存按钮隐藏
          v.isCheckShow = false; // 审核按钮隐藏
          v.pageParams.currency = this.curObj.feeCurrency; // 币种
          v.pageParams.feeFreight = Number(this.curObj.feeFreight).toFixed(2); // 运费
          v.pageParams.feeDeclaration = Number(this.curObj.feeDeclaration).toFixed(2); // 报关费用
          v.pageParams.feeOther = Number(this.curObj.feeOther).toFixed(2); // 其他费用
          v.pageParams.freeType = this.curObj.feeType; // 计费类型 按重量/体积
  ...
  created () {
    this.searchData();
    this.getCognateData(); // 查询关联出库单，若无数据则不显示
    this.declareColumnCopy = this.deepCopy(this.declareColumn);
  },
  methods: {
    updateData (obj) {
      this.submitShipData = obj;
    },
    deleteData (data) {
      this.shipDeleteData.push(...data);
    },
    nextStep () {
      /**
       * 下一步
      ...
      if (v.loading2) return;
      v.loading2 = true;
      let params = v.fixParams();
      if (params.declareDetailBoList.some(i => !i.quantity || i.quantity === 0)) {
        v.$Message.info('申报数量不能为空，ASIN/MSKU必须关联才能申报');
        v.loading2 = false;
        return;
      }
      v.axios.post(api.createFbaInboundShipmentPlan, params).then(response => {
        v.loading2 = false;
        if (response.data.code === 0) {
          let datas = response.data.datas;
          let isText = datas.length > 1;
          datas.forEach((i, index) => {
            let text = isText ? '-' + (index + 1) : '';
            let time = v.$uDate.getDateTime(new Date(), 'customTime');
            i.shipmentName = 'FBA(' + time + ')' + text;
            i.itemList.forEach(j => {
              v.declareData.forEach(k => {
                if (j.sellerSku === k.sellerSku) {
                  j = Object.assign(j, k);
                }
              });
            });
          ...
          this.step = 1;
          this.submitShipData = JSON.parse(JSON.stringify(datas));
          this.shipmentData = datas;
        }
      });
    },
    ...
    fixParams () {
      ...
      if (v.shipDeleteData.length > 0 && v.step === 1) {
        obj.declareDetailBoList.forEach(i => {
          v.shipDeleteData.forEach(j => {
            if (i.sellerSku === j.sellerSku) {
    ...
    pickingObj () {
      ...
      let newObj = {
        ...
        consigneeLinkTel: v.pageParams.consigneeLinkTel ? v.pageParams.consigneeLinkTel : null, // 联系电话
    ...
    searchData () {
      ...
      var v = this;
      var obj = {
        // allotStatus: v.curObj.allotStatus,
        // fromWarehouseId: v.curObj.fromWarehouseId,
        // toWarehouseId: v.curObj.toWarehouseId,
        inventoryAllotNo: v.curObj.inventoryAllotNo
        // inventoryAllotId: v.curObj.inventoryAllotId, // 调拨单id
      ...
      v.axios.post(api.get_transferDetailData, obj).then(res => {
        ...
        if (res.data.code === 0) {
          if (res.data.datas.wmsInentoryAllotProductResult !== null) {
            let data = res.data.datas.wmsInentoryAllotProductResult;
          ...
          v.pageParams.remarks = res.data.datas.remark; // 备注
          // 这些是取收货人和物流商信息
          // if (res.data.datas.wmsPickingExtend !== null) {
          //   v.pageParams.logisticsDealerCode = res.data.datas.wmsPickingExtend.logisticsDealerCode; // 物流商
          //   v.pageParams.logisticsMailCode = res.data.datas.wmsPickingExtend.logisticsMailCode; // 邮寄方式
          //   v.pageParams.consigneeName = res.data.datas.wmsPickingExtend.consigneeName; // 收货人名称
          //   v.pageParams.consigneeCountry = res.data.datas.wmsPickingExtend.consigneeCountry; // 国家
          //   v.pageParams.consigneeLinkMan = res.data.datas.wmsPickingExtend.consigneeLinkMan; // 联系人
          //   v.pageParams.consigneeProvince = res.data.datas.wmsPickingExtend.consigneeProvince; // 省
          //   v.pageParams.consigneeLinkTel = res.data.datas.wmsPickingExtend.consigneeLinkTel !== null ? v.pageParams.consigneeLinkTel = res.data.datas.wmsPickingExtend.consigneeLinkTel : v.pageParams.consigneeLinkTel = ''; // 联系电话
          //   // debugger;
          //   v.pageParams.consigneeCity = res.data.datas.wmsPickingExtend.consigneeCity; // 城市
          //   v.pageParams.consigneeMail = res.data.datas.wmsPickingExtend.consigneeMail !== null ? v.pageParams.consigneeMail = res.data.datas.wmsPickingExtend.consigneeMail : v.pageParams.consigneeMail = ''; // 邮箱
          //   v.pageParams.consigneeAddress = res.data.datas.wmsPickingExtend.consigneeAddress; // 详情地址
          //   v.pageParams.consigneeAddressOther = res.data.datas.wmsPickingExtend.consigneeAddressOther; // 详情地址2
          //   v.pageParams.consigneeZipCode = res.data.datas.wmsPickingExtend.consigneeZipCode !== null ? v.pageParams.consigneeZipCode = res.data.datas.wmsPickingExtend.consigneeZipCode : v.pageParams.consigneeZipCode = ''; // 邮政编码
          //   v.pageParams.logisticsNo = res.data.datas.wmsPickingExtend.logisticsNo; // 物流商单号
          //   v.pageParams.logisticsTrackingNo = res.data.datas.wmsPickingExtend.logisticsTrackingNo; // 跟踪号
          //   v.pageParams.logisticsLinkMan = res.data.datas.wmsPickingExtend.logisticsLinkMan; // 物流商联系人
          //   v.pageParams.logisticsLinkTel = res.data.datas.wmsPickingExtend.logisticsLinkTel !== null ? v.pageParams.logisticsLinkTel = res.data.datas.wmsPickingExtend.logisticsLinkTel : v.pageParams.logisticsLinkTel = ''; // 物流商电话
          //   v.pageParams.logisticsLinkMail = res.data.datas.wmsPickingExtend.logisticsLinkMail !== null ? v.pageParams.logisticsLinkMail = res.data.datas.wmsPickingExtend.logisticsLinkMail : v.pageParams.logisticsLinkMail = ''; // 物流商邮箱
          // }
          if (v.showStatus.allotStatus === '1' || v.showStatus.allotStatus === '2' || v.showStatus.allotStatus === '3' || v.showStatus.allotStatus === '4' || v.showStatus.allotStatus === '5') {
            v.isShow = false;
            v.isCheckShow = false;
            v.isShowBtn = false;
            v.$store.commit('adjustDetailTableShow', 'isChecked');
          } else if (v.showStatus.allotStatus === '0') {
            v.$store.commit('adjustDetailTableShow', 'noCheck');
            v.isShow = true;
            v.isCheckShow = true;
          }
    ...
    addNewProduct () {
      ...
      v.data6 = v.data6.concat(v.userSelectTable); // 待审核
    ...
    getCognateData () {
      // 获取关联出库单数据
      let v = this;
      v.cognatePageParams.inventoryAllotNo = v.curObj.inventoryAllotNo;
      if (v.curObj.warehouseOverseaType) {
        // 第三方仓
        let thirdClounm = [
          {
            title: 'NO.',
    ...
    declareSave () {
      // 申报提交
      let v = this;
      if (v.loading3) return;
      v.loading3 = true;
      let params = {
        confirmedAllotDeclare: v.fixParams(),
        confirmedFbaInboundPlanList: this.submitShipData
      };
      if (!params.confirmedFbaInboundPlanList || params.confirmedFbaInboundPlanList.length === 0) {
        v.loading3 = false;
        v.$Message.info('无申报货品信息');
        return;
      }
      v.axios.post(api.create_amazonDeclare, params).then(response => {
        v.loading3 = false;
        if (response.data.code === 0) {
          v.$Message.success('操作成功');
          v.$store.commit('adjustDetailTableShow', 'isChecked');
        ...
        if (res.data.code === 0) {
          ...
          if (data) {
            data.forEach((n, i) => {
              n.quantityBox = 0;
              n.boxNum = 0;
              n.nowAllocateNum = n.allotInventoryNumber;
            });
            v.declareData = data;
            if (data.length === 1) {
              // 如果只有一条，且未关联则申报置为不可用
