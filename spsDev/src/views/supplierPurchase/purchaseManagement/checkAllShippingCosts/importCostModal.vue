<template>
  <Modal v-model="modalVisible" title="已导入运费数据" width="1280px" max-height="600px">
    <Form ref="modalForm" :model="modalForm" :label-width="80" label-position="right">
      <Row>
        ...
        <Col :span="7">
          ...
          <dyt-select
            v-model="modalForm.createdByList"
            multiple
            clearable
            filterable
            :max-tag-count="1"
    ...
    <div class="table-page clear">
      <div class="table-page-right">
            <Page
              ...
              show-total
              :page-size="modalForm.pageSize"
              show-elevator
              :current="modalForm.pageNum"
              show-sizer
              @on-page-size-change="changePageSiz"
              placement="top"
