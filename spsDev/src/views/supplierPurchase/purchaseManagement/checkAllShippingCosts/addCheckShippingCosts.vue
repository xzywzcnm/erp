        ...
        <div class="card-content mt20">
            ...
            <Row>
              ...
              <FormItem label="收件供应商名称:" prop="supplierId">
                <dyt-select v-model="checkShippingCostForm.supplierId" 
          ...
          <Row>
            ...
            <Col :span="6">
              <FormItem label="运费承担方 和 退/抵形式:" :label-width="180" prop="freightBearInfo">
                <dyt-select v-model="checkShippingCostForm.freightBearInfo" 
                    clearable 
                    placeholder="请选择" > 
                    <Option
            ...
            if (this.businessDeptUser[departmentId].includes(newVal)) {
              ...
              businessDeptArr.forEach(item => {
                if(item.id == departmentId) {
                  businessDept = item.name
                }
              })
            }
            this.businessDept = this.$common.isEmpty(businessDept) ? '' : businessDept
          }
        } else {
          this.businessDept =''
        }
