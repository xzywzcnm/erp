  ...
  <div class="qualityTestPro">
    <div>
      <Form class="formSearch fmb16" inline :label-width="120">
        <FormItem label="质检分类名称:">
          <Input placeholder="请输入质检分类名称"></Input>
        </FormItem>
        <FormItem label="质检项目:">
          <Input placeholder="请输入质检项目名称"></Input>
        </FormItem>
        <FormItem :label-width="30">
          <Button type="primary" icon="ios-search" size="small" class="mr10"
            >查询
          </Button>
    ...
    <div class="orderTable normalTop commonFilter">
      ...
      >
        ...
        <template slot="action">
          <Button size="small" style="margin-right: 5px" type="info"
            >编辑</Button
          >
    ...
    <!--添加质检项目-->
    <Modal v-model="isShowAddDialog" title="添加质检分类" :width="560">
      <div class="normalTop">
