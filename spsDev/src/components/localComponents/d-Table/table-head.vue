              ...
              <div
                ...
                <div :class="[prefixCls + '-filter-list-item']" >
                  <checkbox-group v-model="getColumn(rowIndex, index)._filterChecked" >
                    <checkbox
                        v-for="(item, index) in column.filters" :key="index" :label="item.value" >{{ item.label }}
                    </checkbox >
                  </checkbox-group >
                </div >
                <div :class="[prefixCls + '-filter-footer']" >
                  ...
                  <i-button
                      type="text" size="small" @click.native="handleReset(getColumn(rowIndex, index)._index)" >重置
                  </i-button >
                </div >
              </div >
  ...
  methods: {
    ...
    scheduleLayout (index) {
      ...
      for (let i = 0; i < len; i++) {
        ...
        if (Object.prototype.hasOwnProperty.call(ev, 'fixed')) {
          fixedColumns.push(i);
        }
      }
      if (index < len - 1) {
