<template >
  <table cellspacing="0" cellpadding="0" border="0" :style="styleObject" class="ive-table-body" ref="body" >
    ...
    <template v-for="(row, index) in data" >
      <template v-if="!row.pid && row.pid !== 0" >
        <tr
          ...
          <template v-for="(column, n) in colPos[index]" >
            <td :class="alignCls(column, row)" v-if="column.rowSpan && !column.colSpan" :rowSpan="column.rowSpan" :key="n">
              <Cell
                  :fixed="fixed"
            ...
            <td :class="alignCls(column, row)" v-if="!column.rowSpan && column.colSpan" :colSpan="column.colSpan" :key="n">
              <Cell
                  :fixed="fixed"
                  :prefix-cls="prefixCls"
                  :row="row"
            ...
            <td :class="alignCls(column, row)" :v="column.hide" v-if=" column.hide != 1" :key="n">
              <Cell
                  :fixed="fixed"
                  :prefix-cls="prefixCls"
                  :row="row"
      ...
      <tr v-if="rowExpanded(row._index)" :key="index">
