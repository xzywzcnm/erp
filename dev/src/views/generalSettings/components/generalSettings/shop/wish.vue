...
export default {
            ...
            return h('div', [
              ...
              params.row.wishEnabled !== 0 &&
                ...
                : params.row.wishEnabled !== 0 &&
                  ...
                  : '',
              // params.row.wishEnabled === 0 || params.row.wishEnabled === 2
              //   ?
              h(
                'Button',
                {
  ...
  methods: {
    show (wishAccountId, type, account) {
      let v = this;
      v.showParams = {
        sid: wishAccountId,
        type: type,
