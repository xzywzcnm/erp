...
export default {
  ...
  data () {
    ...
    return {
      ...
      columns: [
        ...
        //   align: 'center',
        //   render: (h, params) => {
        //     if (params.row.tophatterEnabled) {
        //       return h('span', {
        //         style: {
        //           color: '#008000'
        //         }
  ...
  methods: {
    show (tophatterAccountId, type, account) {
      let v = this;
      v.showParams = {
        sid: tophatterAccountId,
        type: type,
        account: account
      };
    }
