...
export default {
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            return h(
              'span',
              'https://' + params.row.shopName + '.myshopify.com'
            );
          }
        },
        {
            ...
            return h('div', [
              ...
              params.row.shopifyEnabled !== 0 &&
                ...
                : params.row.shopifyEnabled !== 0 &&
                  ...
                  : '',
              // params.row.shopifyEnabled === 0 || params.row.shopifyEnabled === 2
              //   ?
              h(
                'Button',
                {
  ...
  methods: {
    show (shopifyAccountId, type, account) {
      let v = this;
      v.showParams = {
        sid: shopifyAccountId,
        type: type,
        account: account
      };
    }
