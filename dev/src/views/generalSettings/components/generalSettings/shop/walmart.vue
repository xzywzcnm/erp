...
export default {
  ...
  methods: {
    show (walmartAccountId, type, account) {
      let v = this;
      v.showParams = {
        sid: walmartAccountId,
        type: type,
        account: account
      };
    }
