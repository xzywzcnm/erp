...
export default {
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            return h(
              'span',
              this.siteName(params.row.lazadaAccountSaleAreaList)
            );
          }
        },
        {
        ...
        },
        {
          ...
          render: (h, params) => {
            return h(
              'span',
              self.getDataToLocalTime(
                params.row.refreshTokenCreatedTime,
                'fulltime'
              )
            );
          }
            ...
            return h('div', [
              ...
              params.row.lazadaStatus !== 0 &&
                ...
                : params.row.lazadaStatus !== 0 &&
                  ...
                  : '',
              // params.row.lazadaStatus === 0 || params.row.lazadaStatus === 2 ?
              h(
                'Button',
                {
                  props: {
  ...
  methods: {
    show (lazadaAccountId, type, account) {
      let v = this;
      v.showParams = {
        sid: lazadaAccountId,
        type: type,
