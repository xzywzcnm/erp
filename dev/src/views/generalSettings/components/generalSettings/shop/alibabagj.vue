...
export default {
  ...
  data () {
    ...
    return {
      ...
      shopPlatformType: 'alibabagj', // 阿里国际
      pageParams: {
        pageNum: 1,
        pageSize: 10,
        searchValue: null,
      ...
      columns: [
        ...
        //   title: '秘钥失效时间',
        //   key: 'refreshTokenTimeout',
        //   minWidth: 160,
        //   align: 'center',
        //   render: (h, params) => {
        //     return h('span', self.getDataToLocalTime(params.row.refreshTokenTimeout, 'fulltime'));
        //   }
        // },
        {
  ...
  methods: {
    show (alibabagjAccountId, type, account) {
      let v = this;
      v.showParams = {
        sid: alibabagjAccountId,
        type: type,
        account: account
      };
    }
