<template >
  <div>
    <!-- 筛选模块 -->
    <shopFilter :pageParams.sync="pageParams" @combineData="combineData" :shopPlatformType="shopPlatformType" :siteList="neweggSiteList"></shopFilter>
    <!-- 排序模块 -->
...
export default {
  ...
  mounted () {
    ...
    if (v.shopPlatformType === 'newegg') {
      v.getLazadaSite('newegg');
    }
    v.getCodeResult();
  }
};
