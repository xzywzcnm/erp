...
export default {
            ...
            return h('div', [
              ...
              params.row.alibabaStatus !== 0 &&
                ...
                : params.row.alibabaStatus !== 0 &&
                  ...
                  : '',
              // params.row.alibabaStatus === 0 || params.row.alibabaStatus === 2
              //   ?
              h(
                'Button',
                {
  ...
  methods: {
    show (alibabaAccountId, type, account) {
      let v = this;
      v.showParams = {
        sid: alibabaAccountId,
        type: type,
        account: account
      };
    }
