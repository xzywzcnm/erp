            ...
            return h('div', [
              ...
              params.row.dhgateStatus !== 0 &&
                ...
                : params.row.dhgateStatus !== 0 &&
                  ...
                  : '',
              // params.row.dhgateStatus === 0 || params.row.dhgateStatus === 2 ?
              h(
                'Button',
                {
                  props: {
