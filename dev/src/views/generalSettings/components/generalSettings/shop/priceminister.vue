...
export default {
  ...
  data () {
    ...
    return {
      ...
      shopPlatformType: 'priceminister',
      pageParams: {
        pageNum: 1,
        pageSize: 10,
        searchValue: null,
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            return h('span', {
              class: 'platformLogo priceminister'
            });
          }
        },
        {
        ...
        },
        {
          ...
          render: (h, params) => {
            return h('div', [
              h(
                'Button',
                {
                  ...
                  on: {
                    click: () => {
                      self.show(
                        params.row.priceministerAccountId,
                        'check',
              ...
              params.row.priceministerEnabled !== 0 &&
  ...
  methods: {
    show (priceministerAccountId, type, account) {
      let v = this;
      v.showParams = {
        sid: priceministerAccountId,
        type: type,
        account: account
      };
    }
