...
export default {
  ...
  data () {
    ...
    return {
      ...
      shopPlatformType: 'factorymarket',
      pageParams: {
        pageNum: 1,
        pageSize: 10,
        searchValue: null,
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            return h('span', {
              class: 'platformLogo factorymarket'
            });
          }
        },
        {
        ...
        {
          title: 'Factorymarket状态',
          key: 'factorymarketStatus',
          width: 160,
          align: 'center',
          render: (h, params) => {
            if (params.row.factorymarketStatus) {
              return h(
                'span',
                {
                  style: {
        ...
        },
        {
          ...
          render: (h, params) => {
            return h('div', [
              ...
              params.row.factorymarketStatus !== 0 &&
                ...
                : params.row.factorymarketStatus !== 0 &&
                  ...
                  : '',
              // params.row.factorymarketStatus === 0 ||
              // params.row.factorymarketStatus === 2
              //   ?
              h(
                'Button',
                {
