...
export default {
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            return h('span', {
              class: 'platformLogo mercadolibre'
            });
          }
        },
        {
        ...
        {
          title: 'Mercadolibre状态',
          key: 'mercadolibreStatus',
          width: 160,
          align: 'center',
          render: (h, params) => {
            if (params.row.mercadolibreEnabled) {
              return h(
                'span',
                {
                  style: {
        ...
        },
        {
          ...
          render: (h, params) => {
            return h('div', [
              h(
                'Button',
                {
                  ...
                  on: {
                    click: () => {
                      self.show(
                        params.row.mercadolibreAccountId,
                        'check',
                        params.row.saleAccount.account
                      );
                    }
              ...
              params.row.mercadolibreEnabled !== 0 &&
                ...
                : params.row.mercadolibreEnabled !== 0 &&
                  ...
                  : '',
              // params.row.mercadolibreEnabled === 0 ||
              // params.row.mercadolibreEnabled === 2
              //   ?
              h(
                'Button',
                {
  ...
  methods: {
    show (mercadolibreAccountId, type, account) {
      let v = this;
      v.showParams = {
        sid: mercadolibreAccountId,
        type: type,
        account: account
      };
    }
