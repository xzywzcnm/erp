...
export default {
    ...
    return {
      ...
      ruleValidate: {
        ...
        distributionPriceValue: [
          { validator: this.distributionPriceValidate, trigger: "blur" },
          { validator: this.distributionPriceValidate, trigger: "change" }
        ]
      },
      isVisible: false
    };
  ...
  methods: {
    ...
    distributionPriceValidate (rule, value, callback) {
