...
Vue.use(Router);
store.commit('inGroup', 'definePlatform');// 需AJAX向server请求菜单
store.commit('platformType', 'definePlatform');// 需AJAX向server请求菜单
...
const routes = [
  {
    ...
    children: [
      {
        path: '/',
        redirect: '/orderToRetrieve'
      },
      {
        path: '/orderToRetrieve',
        component: () => import('@/views/channel/components/channel/orderToRetrieve')// 订单检索
      },
      {
        path: '/stockoutOrder',
        component: () => import('@/views/channel/components/channel/stockoutOrder')// 异常订单
      },
      {
        path: '/unmatchProduct',
        component: () => import('@/views/channel/components/channel/unmatchProduct')// 未匹配商品
      }, {
        path: '/interceptOrder',
        component: () => import('@/views/channel/components/channel/interceptOrder')// 截留订单
      }, {
        path: '/matchTheLogistics',
        component: () => import('@/views/channel/components/channel/matchTheLogistics')
      }, {
        path: '/cancelOrder',
        component: () => import('@/views/channel/components/channel/cancelOrder')// 取消订单
      }, {
        path: '/manualOrder',
...
router.beforeEach(function (to, from, next) {
  ...
  document.title = title ? title + '-订单系统-自定义渠道' : '订单系统-自定义渠道';
  ...
  let menuKey = 'definePlatform_' + pathName === 'definePlatform_'
                ? 'definePlatform_orderToRetrieve'
                : 'definePlatform_' + pathName;
